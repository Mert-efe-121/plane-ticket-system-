document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('ticketForm').addEventListener('submit', function(event) {
        ...
        localStorage.setItem('bookingData', JSON.stringify({ name, email, destination, date, ticketType }));
    ...
    function addToTable(data) {
        ...
        const ticketTypeCell = newRow.insertCell(4);
        const paymentMethodCell = newRow.insertCell(5);
